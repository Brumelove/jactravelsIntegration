package com.travelbeta.jactravels.service.cancel_api.facade;
...
import com.travelbeta.jactravels.service.cancel_api.util.CancelMapperUtil;
...
import lombok.val;
import com.travelbeta.jactravels.service.cancel_api.service.CancelRestService;
...
public class CancelFacade {
    ...
    private CancelResponse cancelJacTravels(CancelRequest cancelRequest) {
        ...
        if (!cancelHotelResponse.getReturnStatus().isSuccess()) {
            ...
            throw new JacTravelAPIException(ErrorMsg.INTERNAL_ERROR_TYPE, cancelHotelResponse.getReturnStatus().getException());
        }
