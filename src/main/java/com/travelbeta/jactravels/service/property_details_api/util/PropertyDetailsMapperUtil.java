package com.travelbeta.jactravels.service.property_details_api.util;
...
import com.travelbeta.jactravels.service.property_details_api.payload.jactravel.request.PropertyDetailsHotelRequest;
import com.travelbeta.jactravels.service.property_details_api.payload.jactravel.response.PropertyDetailsHotelResponse;
...
public class PropertyDetailsMapperUtil {
    ...
    public Function<PropertyDetailsHotelResponse, PropertyDetailsResponse> mapPropertyDetailsResponse = propertyDetailsHotelResponse -> {
        ...
        propertyDetailsResponse.setProductAttributeGroups(propertyDetailsHotelResponse.getProductAttribtuteGroups());
    ...
    public Function<PropertyDetailsRequest, PropertyDetailsHotelRequest> mapPropertyDetailsHotelRequest = propertyDetailsRequest -> {
        val propertyDetailsHotelRequest = new PropertyDetailsHotelRequest();
